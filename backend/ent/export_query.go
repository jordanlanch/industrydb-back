...
func (_q *ExportQuery) QueryUser() *UserQuery {
...
func (_q *ExportQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *ExportQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ExportQuery) FirstIDX(ctx context.Context) int {
...
func (_q *ExportQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ExportQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *ExportQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *ExportQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ExportQuery) WithUser(opts ...func(*UserQuery)) *ExportQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ExportQuery) WithOrganization(opts ...func(*OrganizationQuery)) *ExportQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ExportQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Export, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *Export, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOrganization; query != nil {
		if err := _q.loadOrganization(ctx, query, nodes, nil,
			func(n *Export, e *Organization) { n.Edges.Organization = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ExportQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Export, init func(*Export), assign func(*Export, *User)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Export)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *ExportQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*Export, init func(*Export), assign func(*Export, *Organization)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Export)
	for i := range nodes {
...
func (_q *ExportQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(export.Table, export.Columns, sqlgraph.NewFieldSpec(export.FieldID, field.TypeInt))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(export.FieldUserID)
		}
		if _q.withOrganization != nil {
			_spec.Node.AddColumnOnce(export.FieldOrganizationID)
		}
	}
