...
var (
	...
	LeadsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "name", Type: field.TypeString},
		{Name: "industry", Type: field.TypeEnum, Enums: []string{"tattoo", "beauty", "barber", "spa", "nail_salon", "gym", "dentist", "pharmacy", "massage", "restaurant", "cafe", "bar", "bakery", "car_repair", "car_wash", "car_dealer", "clothing", "convenience", "lawyer", "accountant"}},
