...
func (_c *UserCreate) AddSmsCampaignIDs(ids ...int) *UserCreate {
	_c.mutation.AddSmsCampaignIDs(ids...)
	return _c
}

// AddSmsCampaigns adds the "sms_campaigns" edges to the SMSCampaign entity.
func (_c *UserCreate) AddSmsCampaigns(v ...*SMSCampaign) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSmsCampaignIDs(ids...)
}
...
func (_c *UserCreate) AddEmailCampaignIDs(ids ...int) *UserCreate {
	_c.mutation.AddEmailCampaignIDs(ids...)
	return _c
}

// AddEmailCampaigns adds the "email_campaigns" edges to the EmailCampaign entity.
func (_c *UserCreate) AddEmailCampaigns(v ...*EmailCampaign) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddEmailCampaignIDs(ids...)
}

// AddCrmIntegrationIDs adds the "crm_integrations" edge to the CRMIntegration entity by IDs.
func (_c *UserCreate) AddCrmIntegrationIDs(ids ...int) *UserCreate {
	_c.mutation.AddCrmIntegrationIDs(ids...)
	return _c
}

// AddCrmIntegrations adds the "crm_integrations" edges to the CRMIntegration entity.
func (_c *UserCreate) AddCrmIntegrations(v ...*CRMIntegration) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddCrmIntegrationIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.SmsCampaignsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.EmailCampaignsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.CrmIntegrationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
